...
============================================================= */
const CONFIG = {
    API_URL: "https://script.google.com/macros/s/AKfycbzA20ad7xz6sgcGX9huoeKLEjetEva1b45SADMBXRfYyv7tn7p3bL4o-hqvRz-HS77P/exec",
    ...
    TIMEOUT_MS: 30000,     // 單次請求的逾時上限
    RETRY_COUNT: 1,        // 讀取類請求逾時/網路錯誤時，自動重試的次數（不含第一次）
    RETRY_DELAY_MS: 3000   // 每次重試之間的間隔
};
